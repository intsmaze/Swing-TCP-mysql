...
public class DeleteSolder extends JPanel implements ActionListener {
	/**
	 * 
	 */
	private String url;
	...
	public static void main(String[] args) {
		DeleteSolder cm = new DeleteSolder("127.0.01", 1000);
	...
	public DeleteSolder(String url, int port) {
		this.url = url;
		this.port = port;
		this.initialFrame();
	}

...
public class ChangePwdManager extends JPanel implements ActionListener
{
	...
	public ChangePwdManager(String url,int port)
	{
		this.url=url;
		this.port=port;
		this.initialFrame();
	...
	public static void main(String[] args) {
		ChangePwdManager cm=new ChangePwdManager("127.0.01",1000);

...
public class SolderWork extends JPanel implements ActionListener
{
	...
	public static void main(String[] args) {
		SolderWork cm=new SolderWork("127.0.01",1000);
	...
	public SolderWork(String url,int port)
	{
		this.url=url;
		this.port=port;
		this.initialFrame();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==jb[0])
		{
			try {
				...
				{
					JOptionPane.showMessageDialog(this,"本超市无该商品的信息或库存不足","错误",
